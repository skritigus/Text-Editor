...
List<FontStyle>& StyleManager::getStyles()
{
	return styles;
}

List<FontStyle>& StyleManager::getFilteredStyles()
{
...
void StyleManager::printFontStyles(const List<FontStyle>& styles)
{
	int count = 0;
...
void StyleManager::createFontStyles()
{
	int amount;
	int size;
	std::string name;
...
void StyleManager::editFontStyle()
{
	List<int> parameters;
	int select;
...
void StyleManager::swapFontStyles()
{
	int select1;
	int select2;
...
void StyleManager::deleteFontStyles()
{
	int select;
	List<int> indexes;
...
void StyleManager::filterFontStyles() 
{
	List<int> parameters;
	...
	if (newFilteredStyles.getCount() != 0)
	{
		...
		printFontStyles(newFilteredStyles);
	}
	else
	{
	...
	filteredStyles = std::move(newFilteredStyles);
}